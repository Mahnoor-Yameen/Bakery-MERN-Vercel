...
const { CreateProduct,AllProduct,ProductReviews, ProductByProductCategoryName, ProductByBrandName, ProductByName, ProductByID, UpdateProduct, DeleteProduct } = require('./Controller');
