...
export default function CartItem({ data }) {
  ...
  return (
    <>
      ...
      <div className='card mb-3 shadow-sm' style={{ backgroundColor: "#f9e0b7" }}>
                  ...
                  <div className="col-md-8 col-sm-8 col-8 ">
                    <div className="card-body">
                      ...
                      <div className='d-flex align-items-center justify-content-between'>
                        <span className="badge bg-secondary p-2" style={{ fontSize: "13px" }}>Price:  &#163;{data.ProductPrice}</span>
                      ...
                      <p>Total Price: {data.ProductQuantity * data.ProductPrice}</p>
